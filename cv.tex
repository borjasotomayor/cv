...
\citem{Department of Computer Science}, 2015 -- \emph{present}\\
Senior Lecturer
...
\citem{CMSC 12100 - Computer Science with Applications 1} (2012, 2014 -- \emph{present})\\
...
\citem{CMSC 23300 - Networks and Distributed Systems} (2011 --\emph{present})\\
...
\begin{category}{}
\citem{Director of Systems}, ACM/ICPC Mid-Central USA Programming Contest, 2015 -- \emph{present}\\
...
\citem{Site Director}, Chicago site of the ACM/ICPC Mid-Central USA Programming Contest, 2012 -- \emph{present}\\
...
\citem{Contest Director}, North American Invitational Programming Contest, 2012 -- \emph{present}\\
...
\begin{category}{}
\citem{Steadfast Networks} (Chicago, IL): Advisory Board member. 2011 -- 2017.
\end{category}
...
\begin{category}{}
\citem{Honorable Mention (coach)} (2009 -- 2016)\\
ICPC World Finals
